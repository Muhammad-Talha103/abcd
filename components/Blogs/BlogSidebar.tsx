  ...
  return (
    <div className="flex flex-col gap-16">
      <div className="flex flex-col gap-3">
        ...
        <input type="text" placeholder="Search For Posts" className="w-full h-[40px] outline-none " />
        <span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.33333 12.6667C10.2789 12.6667 12.6667 10.2789 12.6667 7.33333C12.6667 4.38781 10.2789 2 7.33333 2C4.38781 2 2 4.38781 2 7.33333C2 10.2789 4.38781 12.6667 7.33333 12.6667Z" stroke="#CBCBE0" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M13.9996 14L11.0996 11.1" stroke="#CBCBE0" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</span>
        </div>
      </div>
      ...
      <h1
        ...
        <div className="grid  grid-cols-2 gap-4">
              ...
              <p className={`text-[#151875] ${josefinFont.className}  flex pl-3 items-center text-[14px] font-normal hover:bg-[#F939BF] rounded-[3px] hover:text-white cursor-pointer h-[30px]`}>Hobbise (14)</p>
              <p className={`text-[#151875] ${josefinFont.className}  flex pl-3 items-center text-[14px] font-normal hover:bg-[#F939BF] rounded-[3px] hover:text-white cursor-pointer h-[30px]`}>Women (21)</p>
              <p className={`text-[#151875] ${josefinFont.className}  flex pl-3 items-center text-[14px] font-normal hover:bg-[#F939BF] rounded-[3px] hover:text-white cursor-pointer h-[30px]`}>Women (21)</p>
              <p className={`text-[#151875] ${josefinFont.className}  flex pl-3 items-center text-[14px] font-normal hover:bg-[#F939BF] rounded-[3px] hover:text-white cursor-pointer h-[30px]`}>Women (21)</p>
              <p className={`text-[#151875] ${josefinFont.className}  flex pl-3 items-center text-[14px] font-normal hover:bg-[#F939BF] rounded-[3px] hover:text-white cursor-pointer h-[30px]`}>Women (21)</p>
              <p className={`text-[#151875] ${josefinFont.className}  flex pl-3 items-center text-[14px] font-normal hover:bg-[#F939BF] rounded-[3px] hover:text-white cursor-pointer h-[30px]`}>Women (21)</p>
...
<path d="M19.7623 7.29115C19.2057 7.53781 18.6077 7.70448 17.979 7.77981C18.6277 7.39167 19.113 6.78079 19.3443 6.06115C18.7349 6.42314 18.0679 6.67794 17.3723 6.81448C16.9046 6.31506 16.285 5.98403 15.6099 5.87279C14.9347 5.76156 14.2417 5.87634 13.6385 6.19931C13.0353 6.52229 12.5555 7.03539 12.2738 7.65895C11.992 8.28251 11.924 8.98165 12.0803 9.64781C10.8455 9.58581 9.63742 9.26484 8.53462 8.70575C7.43181 8.14665 6.45889 7.36192 5.679 6.40248C5.41233 6.86248 5.259 7.39581 5.259 7.96381C5.2587 8.47514 5.38462 8.97864 5.62559 9.42963C5.86655 9.88063 6.21511 10.2652 6.64033 10.5491C6.14718 10.5335 5.66492 10.4002 5.23367 10.1605V10.2005C5.23362 10.9176 5.48169 11.6127 5.93579 12.1678C6.38989 12.7229 7.02205 13.1038 7.725 13.2458C7.26752 13.3696 6.78789 13.3879 6.32233 13.2991C6.52066 13.9162 6.907 14.4558 7.42724 14.8424C7.94749 15.229 8.57561 15.4433 9.22367 15.4551C8.12356 16.3188 6.76493 16.7872 5.36633 16.7851C5.11859 16.7852 4.87105 16.7707 4.625 16.7418C6.04465 17.6546 7.69723 18.139 9.385 18.1371C15.0983 18.1371 18.2217 13.4051 18.2217 9.30115C18.2217 9.16781 18.2183 9.03315 18.2123 8.89981C18.8199 8.46046 19.3443 7.91641 19.761 7.29315L19.7623 7.29115Z" fill="white"/>
      ...
      <h1
        ...
        <div className="grid grid-cols-3 gap-2 items-center justify-center">
             <p className={`text-[#151875] ${lato.className} underline flex pl-3 items-center text-[14px] font-normal hover:text-[#F939BF] rounded-[3px] cursor-pointer h-[30px]`}>General</p>
             <p className={`text-[#151875] ${lato.className} underline flex pl-3 items-center text-[14px] font-normal hover:text-[#F939BF] rounded-[3px] cursor-pointer h-[30px]`}>Atsanil</p>
             <p className={`text-[#151875] ${lato.className} underline flex pl-3 items-center text-[14px] font-normal hover:text-[#F939BF] rounded-[3px] cursor-pointer h-[30px]`}>Insas.</p>
             <p className={`text-[#151875] ${lato.className} underline flex pl-3 items-center text-[14px] font-normal hover:text-[#F939BF] rounded-[3px] cursor-pointer h-[30px]`}>Bibsaas.</p>
             <p className={`text-[#151875] ${lato.className} underline flex pl-3 items-center text-[14px] font-normal hover:text-[#F939BF] rounded-[3px] cursor-pointer h-[30px]`}>Nulla.</p>
        </div>
      </div>
