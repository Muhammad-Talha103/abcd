...
const ShopList = () => {
  return (
    <div>
        ...
        <Contant tittle='In nulla' price='$26.00' price1='$52.00' image={image2} />
        <Contant tittle='Vel sem' price='$26.00' price1='$52.00' image={image3} />
        <Contant tittle='Porttitor cum' price='$26.00' price1='$52.00' image={image4} />
        <Contant tittle='Nunc in' price='$26.00' price1='$52.00' image={image5} />
        <Contant tittle='Vitae facilisis' price='$26.00' price1='$52.00' image={image6} />
        <Contant tittle='Curabitur lectus' price='$26.00' price1='$52.00' image={image7} />
        </div>
        <Partner/>
    </div>
  )
