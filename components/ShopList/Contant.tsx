          ...
          <div className=" w-full p-4 flex flex-col lg:flex-row gap-3 shadow group ">
           ...
           <div className="flex flex-col gap-5 justify-center"> 
            ...
            <div className="flex flex-col justify-center gap-4  py-2 ">
              ...
              >
              {price} <span className={`${josefinFont.className} line-through text-[15px] leading-[16.4px]  text-[#F701A8] font-normal`} > {price1}</span>                  <span className="flex gap-2">
            ...
            <div className={`${lato.className}  text-[17px] leading-[16.4px] text-[#9295AA] opacity-50  font-normal md:w-[591px]`} >
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem ea cupiditate modi.</p>
            </div>
