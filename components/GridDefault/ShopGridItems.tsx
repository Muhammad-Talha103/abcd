...
import { GridItemsProps } from "../file";
    ...
    <div>
      <Container >
        <div className="py-4 flex items-center justify-center">
          <div className="w-[280px] h-[363px] flex flex-col gap-3  group relative">
            ...
            <div className="flex flex-col items-center justify- gap-4 h-[125px] py-2 ">
              <h3
                className={`${josefinFont.className} font-bold text-[18px] leading-[21.6px] text-accent`}
              >
                {tittle}
              </h3>
              <div className="w-[52px] h-[4px]  flex items-center justify-between">
                <span className="w-[10px] h-[10px] rounded-full bg-[#05E6B7]" />
                <span className="w-[10px] h-[10px] rounded-full bg-[#F701A8]" />
                <span className="w-[10px] h-[10px] rounded-full bg-[#00009D]" />
              </div>
              <p
                className={`${josefinFont.className} text-[14px] leading-[16.4px]  text-[#151875] font-normal`}
              >
              {price} <span className={`${josefinFont.className} line-through text-[14px] leading-[16.4px]  text-[#F701A8] font-normal`} > {price1}</span>
              </p>
            </div>
          </div>
        </div>
